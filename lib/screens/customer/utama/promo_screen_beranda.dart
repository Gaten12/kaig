...
class PromoScreenBeranda extends StatefulWidget {
  const PromoScreenBeranda({super.key});

  @override
  State<PromoScreenBeranda> createState() => _PromoScreenBerandaState();
}

class _PromoScreenBerandaState extends State<PromoScreenBeranda> {
  ...
  Widget _buildActivePromoSection() {
    final activePromos =
        _promoList.where((promo) => promo['isActive']).toList();
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                          'Promo "${promo['title']}" telah diterapkan!'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // 1. Menambahkan AppBar untuk judul dan tombol kembali
      appBar: AppBar(
        // 2. Tombol kembali
        leading: IconButton(
      ...
      // 3. Konten asli sekarang menjadi body dari Scaffold
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
